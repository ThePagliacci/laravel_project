...
Route::prefix('admin')->middleware(['auth', 'isAdmin'])->group(function () { /// route resourse grouplanmak lazim
    Route::get('dashboard', [App\Http\Controllers\Admin\DashboardController::class, 'index'])->name('adminPanel');

    Route::get('book', [App\Http\Controllers\Admin\BooksController::class, 'index'])->name('books');
    ...
    Route::get('genres', [App\Http\Controllers\Admin\BookGenresController::class, 'index'])->name('genres');
    ...
    Route::get('writer', [App\Http\Controllers\Admin\WritersController::class, 'index'])->name('writers');
    ...
    Route::get('comment', [App\Http\Controllers\Admin\CommentController::class, 'index'])->name('comments');
